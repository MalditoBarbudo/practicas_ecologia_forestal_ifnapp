...
### Laboratori Forestal Catalá .font80[(2019-03-07)]
...
tibble(
  ...
  tab_style(
    style = cells_styles(text_weight = 'normal', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(TRUE)
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Porcentaje')
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Orden')
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Valor grupo funcional')
  ) %>%
  tab_style(
    style = cells_styles(
      text_weight = 'normal', text_size = 'medium', text_font = 'Raleway', text_align = 'center'
    ),
    locations = cells_data(TRUE)
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'normal', text_font = 'Raleway'),
...
tibble(
  ...
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Especie dominante')
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Porcentaje especie dominante')
  ) %>%
  tab_style(
    style = cells_styles(text_weight = 'bold', text_size = 'medium', text_font = 'Raleway'),
    locations = cells_column_labels(groups = 'Valor total parcela')
  ) %>%
  tab_style(
    style = cells_styles(
      text_weight = 'normal', text_size = 'medium', text_font = 'Raleway', text_align = 'center'
...
```{r app, echo=FALSE}
knitr::include_app('http://ifnapp.creaf.cat', "550px")
```
