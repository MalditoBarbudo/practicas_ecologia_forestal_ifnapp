...
.center[
```{r lidar_plane, echo=FALSE, out.width=500}
knitr::include_graphics('img/lidar_flight.jpg')
```
]
...
.center[
```{r lidar_init, echo=FALSE, out.width=700}
knitr::include_graphics('img/lidar_app_init.png')
```
]
