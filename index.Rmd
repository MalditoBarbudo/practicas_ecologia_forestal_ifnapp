...
Los vuelos LiDAR usan láseres para crear un mapa 3D de puntos de la superficie a diferentes longitudes
de onda. Aplicando diferentes modelos a los resultados de las medidas en las diferentes longitudes de onda,
y calibrando con los valores reales de la vegetación (IFN), podemos desarrollar modelos para obtener
diferentes variables dasométricas (área basal, altura, biomasa...) de la capa de vegetación.
